  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur-md bg-white/70 dark:bg-gray-900/70 shadow-sm rounded-b-2xl">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            {menuItems.map(item => (
              <button
                ...
                className={`px-4 py-2 rounded-xl text-sm font-medium transition-colors backdrop-blur-sm
                  ${activeSection === item.id
                    ? 'text-red-600 dark:text-red-500 bg-red-50/50 dark:bg-red-900/30'
                    : 'text-gray-700 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-500 hover:bg-gray-50/50 dark:hover:bg-gray-800/50'
                  }`}
              >
                {item.label}
              </button>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="md:hidden p-2.5 rounded-xl hover:bg-gray-100/50 dark:hover:bg-gray-800/50 transition-colors backdrop-blur-sm"
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden pb-4 backdrop-blur-sm">
            <div className="px-2 pt-2 pb-3 space-y-2">
              {menuItems.map(item => (
                <button
                  ...
                  className={`block w-full px-4 py-2.5 rounded-xl text-base font-medium transition-colors
                    ${activeSection === item.id
                      ? 'text-red-600 dark:text-red-500 bg-red-50/50 dark:bg-red-900/30'
                      : 'text-gray-700 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-500 hover:bg-gray-50/50 dark:hover:bg-gray-800/50'
                    }`}
